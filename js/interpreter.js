...
var also, append, apply, boolean_to_string, car, cdr, compose, cons, display, empty, error, given, given_seq, impossibility, is_boolean, is_empty, is_eq, is_equal, is_impossible, is_number, is_possible, is_string, is_symbol, least_acceptable_indent, length, list, list_to_mlist, mappend, matches, mcar, mcdr, mcons, mlength, mlist, mlist_to_list, newline, number_to_string, possibility, raise, repeat, set_car_racket_exclamation_point, set_cdr_racket_exclamation_point, shallow_flatten, string_append, string_length, string_replace, string_to_number, substring, symbol_to_string, _, _racket_division_symbol, _racket_mult_symbol, _racket_plus_symbol,
  __slice = [].slice;
...
var parse = ((function () {var string_capitalize_word = (function (str) {
    ...
    return ((parse_white(str, no_indent))); 
}), (function (str) {(parse_exp(str, indent));
...
var analyze_funject_literal = ((function () {var analyze_pairs = (function (ps) {
    return ((mmap((function (p) {(set_mcadr_racket_exclamation_point(p, (analyze_lazy_expressions((mcadr(p))))));
    return (p); 
}), ps))); 
});; 
