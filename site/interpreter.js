...
(function() {
  ...
  Funject = (function() {
    ...
    Funject.prototype.methodHasArgs = function() {
      var answer, hasArgs, i, length, method, o, p, pattern, _i, _len, _ref;
      method = this;
      hasArgs = null;
    ...
    Funject.prototype.hasSymbol = function(name) {
      var method, p, _i, _j, _len, _len1, _ref, _ref1;
      method = this;
      while (method) {
        if (method.call) {
          _ref = method.call;
    ...
    Funject.prototype.keys = function() {
      var i, length, p, pattern, result, _i, _len, _ref,
        _this = this;
    ...
    Funject.prototype.keysOf = function(c) {
      var k, result, _i, _len, _ref;
      result = [];
      _ref = this.keys().value;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        k = _ref[_i];
        if (k.isMemberOf(c)) {
          result.push(k);
    ...
    Funject.prototype["native"] = function(pattern, argument) {
      var a, args, i, p, x, _i, _j, _len, _len1, _ref, _ref1;
      if (pattern instanceof Array) {
        if (pattern[0] === '|') {
    ...
    Funject.prototype.match = function(interpreter, bound, pattern, argument) {
      var arg, bindings, i, sub, x, _i, _len, _ref;
      if (pattern.type === 'list') {
        bindings = {};
        _ref = pattern.values;
        for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
    ...
    Funject.prototype.apply = function(interpreter, own, argument, _private, instance) {
      var a, applications, arg, args, bindings, bound, exp, i, length, n, offset, p, pattern, provideInterpreter, provideSelf, result, scope, value, _i, _len, _ref, _ref1, _ref2;
      if (instance == null) {
        instance = true;
      }
      if (this.call) {
      ...
      switch (f.type) {
        ...
        case 'funject':
          if (f.isObject()) {
            ...
            o = {};
            _ref1 = f.keysOf(lang.Symbol).value;
            for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
              k = _ref1[_j];
  ...
  yakClass = function(name, extend, _arg) {
    var cast, exports, instance, methods, result, _instance, _ref, _ref1;
  ...
  Interpreter = (function() {
    ...
    Interpreter.prototype.expressions = {
      ...
      "if": function(n) {
        ...
        if (!this.args(0, 0, (condition === lang["true"] ? n.trueBody : (_ref2 = n.falseBody) != null ? _ref2 : {
          type: 'nil'
        }))) {
          return;
        }
      ...
      "class": function(n) {
        var argc, e, exports, externalInstance, instance, p, prototype;
      ...
      application: function(n) {
        ...
        return funject.apply(this, (_ref2 = n.own) != null ? _ref2 : funject, argument, n["private"], n.instance);
      },
      or: logical,
      and: logical
    };
    ...
    Interpreter.prototype.step = function(n) {
      var entry, error, errorFunject, type, _ref2;
      ...
      try {
        ...
        if (error instanceof InterpreterError || error instanceof UserError) {
          errorFunject = (_ref2 = error.error) != null ? _ref2 : this.createError(error.message);
    ...
    Interpreter.prototype.stackTrace = function() {
      var calls, e, n, name, stack, _j, _len1, _ref2;
      stack = '';
  ...
  evaluate = function(source, filename, firstLine, callback) {
    var callbacks, dataCallbacks, e, errorCallbacks, interpreter, result, step, timeout;
    if (filename == null) {
      filename = '<anonymous>';
    }
    if (firstLine == null) {
